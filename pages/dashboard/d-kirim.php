        ...
        <tr>
            ...
            <td>
                <div class="d-flex g-2">
                    ...
                    <a class="btn btn-danger <?= $payment_action ?>" href="../../process/do-payment.process.php?order_id=<?=$data['order_id'] ?>" onclick="return confirm('Proses pembayaran?')">Bayar</a>
                    <a class="btn btn-danger <?= $alpha ?>" href="../../process/get-product.process.php?order_id=<?=$data['order_id'] ?>" onclick="return confirm('apakah barang sudah anda terima?')">Barang diterima</a>
                </div>
            </td>
        </tr>
        <?php endforeach; ?>
